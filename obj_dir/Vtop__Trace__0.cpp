...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+30,(vlSelf->top__DOT__RD1Wire),32);
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgBit(oldp+64,(vlSelf->top__DOT__PCsrsWire));
        bufp->chgIData(oldp+65,(vlSelf->top__DOT__ALUoutWire),32);
        bufp->chgBit(oldp+66,(vlSelf->top__DOT__RegWriteWire));
        bufp->chgBit(oldp+67,(vlSelf->top__DOT__ALUsrcWire));
        bufp->chgCData(oldp+68,(vlSelf->top__DOT__ImmSrcWire),3);
        bufp->chgIData(oldp+69,(vlSelf->top__DOT__aluCPU__DOT__ALUop2),32);
        bufp->chgCData(oldp+70,(vlSelf->top__DOT__control__DOT__opcode),7);
        bufp->chgSData(oldp+71,(vlSelf->top__DOT__extendo__DOT__immediate),12);
        bufp->chgBit(oldp+72,(vlSelf->top__DOT__extendo__DOT__msb));
    }
    bufp->chgBit(oldp+73,(vlSelf->clk));
    bufp->chgBit(oldp+74,(vlSelf->rst));
    bufp->chgIData(oldp+75,(vlSelf->a0out),32);
    bufp->chgIData(oldp+76,(vlSelf->InstructionWire),32);
    bufp->chgIData(oldp+77,(vlSelf->ImmOpWire),32);
    bufp->chgIData(oldp+78,(vlSelf->top__DOT__RegFile__DOT__register_array
                            [(0x1fU & (vlSelf->InstructionWire 
                                       >> 0x14U))]),32);
    bufp->chgBit(oldp+79,((vlSelf->top__DOT__RD1Wire 
                           == vlSelf->top__DOT__aluCPU__DOT__ALUop2)));
    bufp->chgCData(oldp+80,((7U & (vlSelf->InstructionWire 
                                   >> 0xcU))),3);
    bufp->chgCData(oldp+81,((0x1fU & (vlSelf->InstructionWire 
                                      >> 0xfU))),5);
    bufp->chgCData(oldp+82,((0x1fU & (vlSelf->InstructionWire 
                                      >> 0x14U))),5);
    bufp->chgCData(oldp+83,((0x1fU & (vlSelf->InstructionWire 
                                      >> 7U))),5);
    bufp->chgIData(oldp+84,((vlSelf->top__DOT__PCWire 
                             + vlSelf->ImmOpWire)),32);
    bufp->chgIData(oldp+85,(((IData)(vlSelf->top__DOT__PCsrsWire)
