...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+76,"a0out", false,-1, 31,0);
    tracep->declBus(c+77,"InstructionWire", false,-1, 31,0);
    tracep->declBus(c+78,"ImmOpWire", false,-1, 31,0);
    tracep->pushNamePrefix("top ");
    tracep->declBus(c+87,"DW", false,-1, 31,0);
    tracep->declBit(c+74,"clk", false,-1);
    tracep->declBit(c+75,"rst", false,-1);
    tracep->declBus(c+76,"a0out", false,-1, 31,0);
    tracep->declBus(c+77,"InstructionWire", false,-1, 31,0);
    tracep->declBus(c+78,"ImmOpWire", false,-1, 31,0);
    tracep->declBit(c+65,"PCsrsWire", false,-1);
    tracep->declBus(c+30,"PCWire", false,-1, 31,0);
    tracep->declBus(c+66,"ALUoutWire", false,-1, 31,0);
    tracep->declBus(c+31,"RD1Wire", false,-1, 31,0);
    tracep->declBus(c+79,"RD2Wire", false,-1, 31,0);
    tracep->declBit(c+80,"EQWire", false,-1);
    tracep->declBit(c+67,"RegWriteWire", false,-1);
    tracep->declBit(c+68,"ALUsrcWire", false,-1);
    tracep->declBus(c+81,"ALUctrlWire", false,-1, 2,0);
    tracep->declBus(c+69,"ImmSrcWire", false,-1, 2,0);
    ...
    tracep->declBit(c+74,"clk", false,-1);
    tracep->declBit(c+75,"rst", false,-1);
    tracep->declBit(c+65,"PCsrc", false,-1);
    tracep->declBus(c+78,"ImmOp", false,-1, 31,0);
    tracep->declBus(c+30,"PCC", false,-1, 31,0);
    tracep->declBus(c+32,"inc_PC", false,-1, 31,0);
    tracep->declBus(c+85,"branch_PC", false,-1, 31,0);
    ...
    tracep->declBit(c+74,"clk", false,-1);
    tracep->declBus(c+82,"AD1", false,-1, 4,0);
    tracep->declBus(c+83,"AD2", false,-1, 4,0);
    tracep->declBus(c+84,"AD3", false,-1, 4,0);
    tracep->declBit(c+67,"WE3", false,-1);
    tracep->declBus(c+66,"WD3", false,-1, 31,0);
    tracep->declBus(c+31,"RD1", false,-1, 31,0);
    tracep->declBus(c+79,"RD2", false,-1, 31,0);
    ...
    tracep->declBus(c+87,"DATAWIDTH", false,-1, 31,0);
    tracep->declBus(c+31,"ALUop1", false,-1, 31,0);
    tracep->declBus(c+81,"ALUctrl", false,-1, 2,0);
    tracep->declBit(c+68,"ALUsrc", false,-1);
    tracep->declBus(c+79,"regOp2", false,-1, 31,0);
    tracep->declBus(c+78,"ImmOp", false,-1, 31,0);
    tracep->declBus(c+66,"ALUout", false,-1, 31,0);
    tracep->declBit(c+80,"Eq", false,-1);
    tracep->declBus(c+70,"ALUop2", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("control ");
    tracep->declBus(c+87,"AW", false,-1, 31,0);
    tracep->declBit(c+80,"Eq", false,-1);
    tracep->declBus(c+77,"instr", false,-1, 31,0);
    tracep->declBit(c+67,"RegWrite", false,-1);
    tracep->declBus(c+81,"ALUctrl", false,-1, 2,0);
    tracep->declBit(c+68,"ALUsrc", false,-1);
    tracep->declBus(c+69,"ImmSrc", false,-1, 2,0);
    tracep->declBit(c+65,"PCsrc", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+31,(vlSelf->top__DOT__RD1Wire),32);
    ...
    bufp->fullBit(oldp+65,(vlSelf->top__DOT__PCsrsWire));
    bufp->fullIData(oldp+66,(vlSelf->top__DOT__ALUoutWire),32);
    bufp->fullBit(oldp+67,(vlSelf->top__DOT__RegWriteWire));
    bufp->fullBit(oldp+68,(vlSelf->top__DOT__ALUsrcWire));
    bufp->fullCData(oldp+69,(vlSelf->top__DOT__ImmSrcWire),3);
    bufp->fullIData(oldp+70,(vlSelf->top__DOT__aluCPU__DOT__ALUop2),32);
    bufp->fullCData(oldp+71,(vlSelf->top__DOT__control__DOT__opcode),7);
    bufp->fullSData(oldp+72,(vlSelf->top__DOT__extendo__DOT__immediate),12);
    bufp->fullBit(oldp+73,(vlSelf->top__DOT__extendo__DOT__msb));
    bufp->fullBit(oldp+74,(vlSelf->clk));
    bufp->fullBit(oldp+75,(vlSelf->rst));
    bufp->fullIData(oldp+76,(vlSelf->a0out),32);
    bufp->fullIData(oldp+77,(vlSelf->InstructionWire),32);
    bufp->fullIData(oldp+78,(vlSelf->ImmOpWire),32);
    bufp->fullIData(oldp+79,(vlSelf->top__DOT__RegFile__DOT__register_array
                             [(0x1fU & (vlSelf->InstructionWire 
                                        >> 0x14U))]),32);
    bufp->fullBit(oldp+80,((vlSelf->top__DOT__RD1Wire 
                            == vlSelf->top__DOT__aluCPU__DOT__ALUop2)));
    bufp->fullCData(oldp+81,((7U & (vlSelf->InstructionWire 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+82,((0x1fU & (vlSelf->InstructionWire 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+83,((0x1fU & (vlSelf->InstructionWire 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+84,((0x1fU & (vlSelf->InstructionWire 
                                       >> 7U))),5);
    bufp->fullIData(oldp+85,((vlSelf->top__DOT__PCWire 
                              + vlSelf->ImmOpWire)),32);
    bufp->fullIData(oldp+86,(((IData)(vlSelf->top__DOT__PCsrsWire)
